...
def PredictData():
    ...
    df = pd.read_csv('./outputs/datas/mytracks.csv')
...
def predict():
    ...
    y_pred = PredictData()
    print("y_pred : ", y_pred)
    # render template index.html et envoi de la variable y_pred dans le span id="result"
    return render_template('index.html', predict=y_pred)
